...
username = "testuser"
secret_name = "smart_goal_generator_agent"

role_name = f"SmartGoalGeneratorBedrockAgentCoreRole-{REGION}"
policy_name = f"SmartGoalGeneratorBedrockAgentCorePolicy-{REGION}"
...
def get_cognito_client_secret() -> str:
    ...
    response = client.describe_user_pool_client(
        UserPoolId=get_ssm_parameter("/app/smartgoalgenerator/agentcore/userpool_id"),
        ClientId=get_ssm_parameter("/app/smartgoalgenerator/agentcore/machine_client_id"),
    )
...
def save_smart_goal_secret(secret_value):
    ...
    try:
        secrets_client.create_secret(
            ...
            Description="Secret containing the Cognito Configuration for the Smart Goal Generator Agent",
        )
...
def setup_cognito_user_pool():
    ...
    try:
        ...
        save_smart_goal_secret(json.dumps(cognito_config))
...
def create_agentcore_runtime_execution_role():
        ...
        "Statement": [
            ...
            },
            {
                ...
                "Resource": [
                    ...
                    f"arn:aws:bedrock-agentcore:{region}:{account_id}:workload-identity-directory/default/workload-identity/smart_goal_generator_agent-*",
                ],
            },
            {
    ...
    try:
        ...
        put_ssm_parameter(
            "/app/smartgoalgenerator/agentcore/runtime_execution_role_arn",
...
def runtime_resource_cleanup():
    try:
        ...
        for repo in repositories['repositories']:
            if 'bedrock-agentcore-smart_goal_generator_agent' in repo['repositoryName']:
...
def delete_observability_resources():
    # Configuration
    log_group_name = "agents/smart-goal-assistant-logs"
